...
export default function NotesPage() {
  ...
  if (conversion.status === "failed") {
    return (
      <div className="flex flex-col items-center justify-center min-h-full w-full px-6 py-8 text-center">
        {conversion.error && (
          <p
        ...
        <button
          ...
          className="text-base font-medium px-4 py-2 rounded-lg border border-zinc-300 dark:border-zinc-600 hover:bg-zinc-100 dark:hover:bg-zinc-800 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {rerunLoading
            ? "Attempting…"
            : "Previous conversion failed. Click to attempt conversion again"}
        </button>
        {rerunError && (
  ...
  return (
    <div className="mx-auto max-w-3xl px-12 pt-36 pb-16 leading-relaxed">
